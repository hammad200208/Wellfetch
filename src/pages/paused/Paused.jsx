...
import { FiCalendar, FiCreditCard, FiXCircle, FiPlay } from "react-icons/fi";
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-sm text-black/60 mb-6">
            Home &gt; <span className="text-black">My Account</span>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-black/60">
                  ...
                  <Link to="/paused">
                    <li className="text-[#D8A85B] font-medium cursor-pointer">Paused</li>
                  </Link>
                  <Link to="/cancelled">
                    <li className="cursor-pointer hover:text-black">Cancelled</li>
                  </Link>
                </ul>
              </div>
            </aside>
            ...
            <div className="lg:w-3/4 bg-white rounded-xl shadow-md p-6 md:p-8 lg:p-10 my-4 md:my-6 lg:my-8">
              ...
              {/* Header */}
              <div className="mb-6">
                <h2 className="text-lg font-semibold text-[#D8A85B]">Paused Subscriptions</h2>
                ...
                <div className="flex flex-col md:flex-row gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <button className="px-4 py-2 rounded-full text-xs border border-[#4C9E84] text-[#4C9E84] font-bold flex items-center gap-1">
                        <FiPlay />
                        Resume Order
                      </button>

                      <button className="px-4 py-2 rounded-full text-xs border border-[#FF3333] text-[#FF3333] font-bold flex items-center gap-1">
                        <FiXCircle />
                        Cancel
                      </button>
                    </div>
